...
(function() {
  ...
  MT("eviltest",
     "[keyword xquery] [keyword version] [variable &quot;1][keyword .][atom 0][keyword -][variable ml&quot;][def&variable ;]      [title (: this is       : a          \"title\" :)]",
     ...
     "          [keyword //][variable x] }                 [title (: a more 'evil' test :)]",
     "      [title (: Modified Blakeley example (: with nested title :) ... :)]",
