...
(function() {
  ...
  MT('html',
      '[title <div id="wrapper">]',
      '[title <section id="introduction">]',
      '',
      ...
      '[variable-2 * Item two]',
      '',
      '[title <a href="http://example.com">Example</a>]',
      '',
      '[title </section>]',
      '[title </div>]');

  MT('inlineHtml',
      'I can use HTML directly in my [title <span class="youbetcha">Textile</span>].');
